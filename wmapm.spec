...
%description
WMAPM monitors the APM statistics through the APM support in the Linux
kernel. WMAPM currently provides:
...
através do suporte APM do kernel. Esta informação é útil para usuários
de laptops.
